...
%%%           2012-2015 Elias Assmann          %%%
%%%
%%% $Id: woptic_userguide.tex 442 2015-11-09 11:35:01Z assmann $

\input{header.tex}

\svnidlong
{$HeadURL: svn+ssh://hclm/var/svn/wien2wannier/trunk/woptic/doc/woptic_userguide.tex $}
{$LastChangedDate: 2015-11-09 12:35:01 +0100 (Mon, 09 Nov 2015) $}
{$LastChangedRevision: 442 $}
{$LastChangedBy: assmann $}
\svnid{$Id: woptic_userguide.tex 442 2015-11-09 11:35:01Z assmann $}
...
\date{for version 1.0.0-alpha-\svnrev}
...
\begin{equation}
  \label{eq:optcond}
  \tag{$*$}
  σ_{αβ}(Ω) = \frac{2\pi e^2 \hbar}{V_\text{\uc}}
  \sum_k \int\!\dd ω\mathop{} \frac{f(ω)-f(ω+Ω)}{Ω}
  \tr\left[A(ω,k)\,V^α(k)\,A(ω,k)\,V^β(k)\right],
\end{equation}
%
where $σ_{αβ}$ is the $(α,β)$ element of the optical conductivity
...
by Vienna University of Technology and the European Research Council
through grant agreement no. 306447.
...
\begin{quote}
  ...
  \name{K. Held},\\
%  Comp. Phys. Commun. \textbf{XXX}, YYYY~(2015),
...
the errors commited in each of them.  Ref.~\cite{Peierls} tests the
...
\bibitem{Tomczak2009a}
  ...
  \textit{Optical properties of correlated materials: Generalized
    {P}eierls approach and its application to {${\text{VO}}_{2}$}.}
...
\bibitem{Jan}
  ...
  \href{http://hal.archives-ouvertes.fr/docs/00/50/36/63/PDF/Tomczak.pdf}{
...
\bibitem{woptic}
  \name{P. Wissgott, E. Assmann, J. Kuneš, A. Toschi, P. Blaha,} and
  \name{K. Held.}
  ...
  %   Comp. Phys. Commun. \textbf{XXX}, YYYY~(2015),
  % }
  \href{http://arxiv.org/abs/}{arXiv:15UU.WWWW}.
...
\bibitem{Peierls} \name{P. Wissgott, J. Kuneš, A. Toschi,} and
  ...
  \textit{Dipole matrix element approach versus Peierls approximation
    for optical conductivity.}
  \href{http://journals.aps.org/prb/abstract/10.1103/PhysRevB.85.205133}{%
...
%%% Time-stamp: <2015-11-09 12:32:26 assman@faepop36.tu-graz.ac.at>
